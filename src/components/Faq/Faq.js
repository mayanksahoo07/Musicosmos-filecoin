...
export default function Faq() {
	var generalQuestions = [
		...
		},
		{
			...
			answer: "This is a somewhat loaded question, but in simple terms Polygon network is faster and cheaper than other alternatives. It is more advanced and better option for future projects to be built upon. Also, Polygon gas fees are cheaper than other alternatives.",
		},
		{
			ID: "heading4",
	...
	var needQuestions = [
		...
		},
		{
			...
			answer: `<span class="green_subhead">What is MATIC? Why do I need it?</span>
					<br/>
					<ul>
						<li>MATIC is a digital currency that powers the Polygon network, which is what Musicosmos is built on. MATIC acts like any other currency— its value fluctuates with the market.</li>
						<li>You need to convert your currency (e.g. USD, INR, CAD, GBP) into MATIC to trade NFTs on Musicosmos.</li>
					</ul>
			`,
		},
	];
	...
	var transactionsAndTechnicalQuestions = [
		{
			...
			question: "What’s Polyscan?",
			answer: `Polyscan is a read-only interface for the Polygon network. It tells you everything that’s happened on the blockchain. It helps you verify that transactions were successful, and tracks other helpful details about transactions and addresses.`,
		},
		{
			ID: "heading28",
